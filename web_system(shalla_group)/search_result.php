        ...
        <?php else: ?>
            <ul class="results-list">
                <?php foreach ($search_results as $product): ?>
                    ...
                    <img src="/web_system(shalla_group)/home_img/<?php echo htmlspecialchars($product['image_url']); ?>" alt="<?php echo htmlspecialchars($product['item_name']); ?>" class="product-image">
